...
/* harmony import */ var _modules_gym_membership__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/gym-membership */ "./js/modules/gym-membership.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/form */ "./js/modules/form.js");
/* harmony import */ var _modules_trainers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/trainers */ "./js/modules/trainers.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])(); // findVideos();
  // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_gym_membership__WEBPACK_IMPORTED_MODULE_4__["setupTabs"])();
    ...
    Object(_modules_form__WEBPACK_IMPORTED_MODULE_5__["setMaskTel"])();
  });
}); // ---------------------------------
...
var feedbackSwiper = feedback.querySelector('.swiper');
var feedbackSwiperButtonPrev = feedbackSwiper.querySelector('.feedback__swiper-button-prev');
var feedbackSwiperButtonNext = feedbackSwiper.querySelector('.feedback__swiper-button-next');
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](feedbackSwiper, {
...
var telInput = document.querySelector('[data-phone-pattern]');
var MIN_TEL_LENGTH = 17;
...
function setMaskTel() {
  ...
  telInput.addEventListener('input', function () {
    var valueLength = telInput.value.length;

    if (valueLength < MIN_TEL_LENGTH) {
      telInput.setCustomValidity("\u0415\u0449\u0451 ".concat(MIN_TEL_LENGTH - valueLength, " \u0441\u0438\u043C\u0432."));
    } else {
...
/***/ "./js/modules/gym-membership.js":
/*!**************************************!*\
  !*** ./js/modules/gym-membership.js ***!
  \**************************************/
/*! exports provided: setupTabs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setupTabs", function() { return setupTabs; });
function setupTabs() {
  var buttons = document.querySelectorAll('.gym-membership__tabs-nav-button');
  var tabPanels = document.querySelectorAll('.gym-membership__tabs-panel');
  ...
  for (var i = 0; i < buttons.length; i++) {
    buttons[i].addEventListener('click', function (e) {
      ...
      for (var j = 0; j < buttons.length; j++) {
        var contentAttr = tabPanels[j].getAttribute('data-tab-content');
...
var gymMembershipTarget = document.getElementById('gym-membership');
var linkGymMembership = document.querySelector('a[href="#gym-membership"]');

function scrollSmooth() {
  linkGymMembership.addEventListener('click', function (evt) {
    evt.preventDefault();
...
var trainars = document.querySelector('.trainers');
var trainersSwiper = trainars.querySelector('.swiper');
var trainarsSwiperButtonPrev = trainersSwiper.querySelector('.swiper-button-prev');
var trainarsSwiperButtonNext = trainersSwiper.querySelector('.swiper-button-next');
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](trainersSwiper, {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
